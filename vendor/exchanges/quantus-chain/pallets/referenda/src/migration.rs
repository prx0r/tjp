...
pub mod test {
	...
	pub fn referendum_status_v0() {
		...
		let ongoing_encoded = sp_core::Bytes::from_str("0x00000000014805002a000000000000000100000000000000000100000000000000010000000000000001000000000000000a00000000000000000000000000000000000100").unwrap();
